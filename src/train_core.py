...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='saved_weights/occlusion_linemod/cat')
    parser.add_argument('--load_dir', type=str, default='saved_weights/occlusion_linemod/cat/checkpoints/0.02/499')
